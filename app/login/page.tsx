...
export default function LoginPage() {
  ...
  return (
    <>
      ...
      {loading && (
        <div className="fixed inset-0 bg-beagle-dark/90 backdrop-blur-sm flex items-center justify-center z-50 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl p-8 shadow-2xl flex flex-col items-center gap-4 min-w-[280px] animate-in zoom-in-95 duration-300">
            <svg 
              className="animate-spin h-16 w-16 text-beagle-orange" 
            ...
            <div className="text-center">
              <p className="text-lg font-semibold text-beagle-dark">Signing you in...</p>
